...
(Scratch => {
  ...
  if (!Scratch.extensions.unsandboxed) {
    throw new Error('Box2D Physics must be run unsandboxed');
  }
  ...
  */
  ...
  // End of the Box2D Physics library that this extension uses
  ...
  */
  ...
  Scratch.extensions.register(new ScratchBox2DPhysics());
})(Scratch);
