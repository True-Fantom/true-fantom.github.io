(Scratch => {
  ...
  const protocols = ['https:', 'http:', 'data:', 'file:', 'blob:', 'chrome:', 'edge:', 'brave:', 'browser:', 'about:', 'extension:', 'chrome-extension:', 'steam:', 'spotify:', 'zoommtg:', 'magnet:', 'mailto:', 'ms-clock:', 'ms-calculator:', 'ms-windows-store:', 'ms-word:', 'ms-excel:', 'ms-acess:', 'ms-powerpoint:', 'ms-settings:', 'ms-settings-privacy:', 'ms-settings-bluetooth:', 'streamdeck:'];
