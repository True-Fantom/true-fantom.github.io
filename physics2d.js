      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            opcode: "setPhysics",
            blockType: Scratch.BlockType.COMMAND,
            text: "enable for [shape] mode [mode]",
            arguments: {
              shape: {
                type: Scratch.ArgumentType.STRING,
                menu: "ShapeTypes",
          ...
          // applyAngForce (target, pow) {
          {
            opcode: "setVelocity",
            blockType: Scratch.BlockType.COMMAND,
            text: "set velocity to sx: [sx] sy: [sy]",
            arguments: {
              sx: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 0,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "change velocity by sx: [sx] sy: [sy]",
            arguments: {
              sx: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 0,
          ...
          "---",
          {
            opcode: "applyForce",
            blockType: Scratch.BlockType.COMMAND,
            text: "push with force [force] in direction [dir]",
            arguments: {
              force: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 25,
          ...
          },
          {
            ...
            func: "setRestitution",
            blockType: Scratch.BlockType.COMMAND,
            text: "set bounce to [restitution]",
            arguments: {
              restitution: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 20,
          ...
          },
          {
            opcode: "changeScroll",
            blockType: Scratch.BlockType.COMMAND,
            text: "change scroll by x: [ox] y: [oy]",
            arguments: {
              ox: {
                type: Scratch.ArgumentType.NUMBER,
                defaultValue: 0,
